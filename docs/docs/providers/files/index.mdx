...
The Files API integrates with Vector Stores to enable document processing and search. For detailed information about this integration, see [File Operations and Vector Store Integration](../concepts/file_operations_vector_stores).
...
See the [Files Providers](/docs/providers/files/) documentation for detailed configuration options.
