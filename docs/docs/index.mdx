...
The Responses API implementation conforms to the [Open Responses](https://www.openresponses.org/) specification. See the [API conformance report](./api-openai/conformance) for detailed coverage.
...
See the [provider documentation](./providers/index) for the full list and the [provider compatibility matrix](./api-openai/provider_matrix.md) for tested feature coverage across providers.
