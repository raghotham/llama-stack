...
For property-level conformance details and missing endpoints, see the [conformance report](./conformance).
...
For a detailed breakdown of schema differences and conformance issues by endpoint, see the [conformance report](./conformance) and the [Responses API limitations](../providers/openai_responses_limitations).
